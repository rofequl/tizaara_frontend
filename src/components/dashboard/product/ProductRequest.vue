  ...
  <div class="content pr-md-5">
    ...
    <div class="row mb-3">
      <div class="col-12 col-sm-6 text-center text-sm-left mb-4 mb-sm-0">
        ...
        <h3 class="page-title" v-if="type === 2">Request for Flash Deal</h3>
        <h3 class="page-title" v-if="type === 1">Request for Ecommerce Zone</h3>
      </div>
      <div class="col-12 col-sm-6 d-flex align-items-center">
        <div class="mx-auto ml-sm-auto mr-sm-0">
          <b-button variant="success"
                    @click="$router.push({name: 'product-list'})" size="sm"
                    class="text-white"><i class="fas fa-hand-point-left"></i> Back to Product-list Page
          </b-button>
        </div>
      </div>
    </div>
