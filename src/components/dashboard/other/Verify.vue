  ...
  <div class="row justify-content-center">
    <div class="col-12 col-md-8 my-4">
      <div v-if="user.status == 1">
        ...
        <h4 class="text-center text-capitalize mt-3">Please wait for admin approval</h4>
        <p class="text-center">when approve we send you mail</p>
      </div>
      <div v-if="user.status == 0" class="card">
        <div class="card-header">
          <strong>Please</strong> insert all missing information for admin verify
        </div>
        <div class="card-body card-block">
          <form @keydown="form.onKeydown($event)" class="form-horizontal">
            <div class="row form-group mb-4">
              <div class="col col-md-3"><label class=" form-control-label">I am a</label></div>
            ...
            <div class="form-row mb-4">
              ...
              <div class="form-group col-md-4">
                <b-form-input class="form-control" id="last-name" v-model="form.last_name"
                              placeholder="Last Name" type="text" disabled
                ></b-form-input>
              </div>
            </div>
            <div class="row form-group mb-4">
            ...
            <div class="row form-group mb-4">
              <div class="col col-md-3"><label class=" form-control-label">Phone Number:</label>
              </div>
              <div class="col-12 col-md-8">
